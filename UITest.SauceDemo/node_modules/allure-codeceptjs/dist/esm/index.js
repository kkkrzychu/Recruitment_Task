...
var allurePlugin = config => {
  ...
  mocha.reporter(AllureCodeceptJsReporter.prototype.constructor, _objectSpread(_objectSpread({}, config), currentReporter ? {
    extraReporters: [currentReporter, mocha.options.reporterOptions]
  } : {}));
  return _objectSpread(_objectSpread({}, allureCodeceptJsLegacyApi), {}, {
